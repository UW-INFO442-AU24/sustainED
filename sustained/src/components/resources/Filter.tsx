...
export default function Filter(props: FilterData) {
    ...
    return (
        <div className='filter-box resource'>
            ...
            <select className="filter-option" id="environmentTopicFilter" onChange={handleEnvironmentChange} >
                <option value="">All</option>
            ...
            <select className="filter-option" id="gradeLevelFilter" onChange={handleGradeLevelChange} >
            ...
            <input className="filter-option" type="text" id="search" name="library_search"
